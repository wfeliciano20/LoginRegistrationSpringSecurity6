package com.williamfeliciano.login_registration_jwt_spring_security_6.filters;

import com.williamfeliciano.login_registration_jwt_spring_security_6.services.JwtService;
    ...
    protected void doFilterInternal(
        ...
        if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (jwtService.isTokenValid(jwt, userDetails)) {
                ...
                // we pass null as the second argument because we wont have extra authorities
